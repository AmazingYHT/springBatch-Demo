package com.jack.springboot13batch.quartzConf;

import java.util.HashMap;
import java.util.Map;

import com.jack.springboot13batch.quartzBean.QuartzJobLauncher;
...
public class QuartzConfiguration {
    ...
    public JobDetailFactoryBean jobDetailFactoryBean(){
        ...
        jobFactory.setName("importJob");
        Map<String, Object> map = new HashMap<>();
        map.put("jobName", "importJob");
